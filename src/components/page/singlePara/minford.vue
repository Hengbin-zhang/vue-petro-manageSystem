	...
	<div>
		<div class="crumbs">
			<el-breadcrumb separator="/">
				<el-breadcrumb-item>
					<span style="color: #FFFFFF;margin-left: 5px;">管汇单参数分析</span>
				</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<div class="container">
			<div class="handle-box">
				...
				<el-row>
					<el-col :span="8" style="margin: 6px;">
						<span style="color: #FFFFFF;margin: 5px;">单个管汇参数历史数据</span>
						<div id="historyData" style="height: 400px;"></div>
						<el-row></el-row>
						<br />
						<span style="color: #FFFFFF;margin: 5px;">历史数据记录</span>
					...
					<el-col :span="7" style="margin: 6px;">
						<span style="color: #FFFFFF;margin: 5px;">预测趋势记录</span>
						<el-table style="width: fit-content;" border>
							<el-table-column label="编号" type="index" width="55"></el-table-column>
							<el-table-column label="监测点" prop="" width="80"></el-table-column>
							<el-table-column label="区段1" prop="" width="90"></el-table-column>
